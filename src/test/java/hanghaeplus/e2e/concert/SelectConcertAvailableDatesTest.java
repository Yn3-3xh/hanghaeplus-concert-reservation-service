...
public class SelectConcertAvailableDatesTest {
    ...
    @Test
    @DisplayName("예약 가능 날짜 조회 테스트 - 통과")
    void pass_selectConcertAvailableDatesTest() {
        ...
        when(concertFacade.selectConcertAvailableDates(new ConcertRequest.ConcertAvailableDates(tokenId, 1L)))
                .thenReturn(new ConcertResponse.ConcertAvailableDates(List.of()));
