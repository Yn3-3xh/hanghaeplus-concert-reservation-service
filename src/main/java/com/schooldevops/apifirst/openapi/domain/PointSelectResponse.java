...
public class PointSelectResponse implements Serializable {

  private static final long serialVersionUID = 1L;

  private Integer point;

  public PointSelectResponse point(Integer point) {
    this.point = point;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    PointSelectResponse pointSelectResponse = (PointSelectResponse) o;
    return Objects.equals(this.point, pointSelectResponse.point);
  }
  ...
  public String toString() {
    ...
    sb.append("class PointSelectResponse {\n");
